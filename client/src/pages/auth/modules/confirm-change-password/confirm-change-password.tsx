...
export default function ConfirmChangePassword() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (newPassword === confirmPassword) {
            ...
            const response = await fetch(`${BACKEND_SERVER}/auth/confirm-change-password`, {
                method: 'POST',
                headers: {
        ...
        <div className="Container min-h-screen flex flex-col items-center justify-center">
            ...
            <div className="z-10 bg-white p-6 rounded-2xl shadow-lg w-full mb-8">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    />
                    <Button
                        isLogin={false} // Set isLogin to false for this button
                        onClick={handleSubmit}
                        text="Confirmar cambio" // Texto del botón
                        rounded="rounded-full"
                        className="px-3 text-base mb-4" // Añadido margen inferior
                    />
                    <Button
                        isLogin={true} 
