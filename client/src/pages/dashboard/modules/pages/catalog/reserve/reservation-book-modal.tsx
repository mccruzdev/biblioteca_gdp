  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="reservation-modal__content">
        <DialogHeader>
          <DialogTitle className="reservation-modal__title">
            Realiza tu reserva
          </DialogTitle>
          <DialogDescription className="reservation-modal__description">
            {selectedBook && (
              <>
                Selecciona la fecha, hora y copia para el libro "
                {selectedBook.title}"
              </>
            )}
          </DialogDescription>
        ...
        <div className="reservation-modal__grid">
          <div className="grid gap-2">
            <Label htmlFor="copy" className="reservation-modal__label">
              Copia del libro
            </Label>
            <Select
              ...
              onValueChange={(value) =>
                setSelectedCopy(
                  copies.find((c) => c.id === parseInt(value)) || null
                )
              }
            >
              <SelectTrigger
                id="copy"
                className="reservation-modal__select-trigger"
              >
              ...
              <SelectContent className="reservation-modal__select-content">
                {copies.map((copy) => (
                  ...
                  >
                    {`Código: ${copy.code || "N/A"} - Condición: ${
                      copy.condition === "NEW"
                        ? "Nuevo"
                        : copy.condition === "GOOD"
                        ? "Bueno"
          ...
          <div className="grid gap-2">
            <Label htmlFor="date" className="reservation-modal__label">
              Fecha de recojo
            </Label>
            <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
              ...
              <PopoverContent
                className="w-auto p-0 reservation-modal__select-content"
                align="start"
              >
                <Calendar
                  mode="single"
          ...
          <div className="grid gap-2">
            <Label htmlFor="time" className="reservation-modal__label">
              Hora de recojo
            </Label>
